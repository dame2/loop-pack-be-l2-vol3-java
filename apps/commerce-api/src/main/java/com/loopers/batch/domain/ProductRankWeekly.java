...
/**
 * 주간 상품 랭킹 도메인 모델.
 * 매주 배치 Job에 의해 생성되며, TOP 100 상품의 주간 집계 데이터를 보관합니다.
 */
public class ProductRankWeekly {
    ...
    /**
     * 새로운 주간 랭킹 엔트리를 생성합니다.
     */
    public static ProductRankWeekly create(
        Long productId,
        int rankNumber,
        BigDecimal totalScore,
        long totalViewCount,
     ...
     */
    public static ProductRankWeekly reconstitute(
        Long id,
        Long productId,
        int rankNumber,
        BigDecimal totalScore,
